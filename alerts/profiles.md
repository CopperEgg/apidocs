...
Notifications are now separate from Alert Definitions. Each Alert Definition can be associated with zero or more Notification Profiles.
...
To navigate to the Notification Profiles page: in the CopperEgg UI, click on the Issues tab; then click on Notification Profiles in the Left Navigation panel.

###User Notification Profiles
A default User Notification Profile is created by CopperEgg when a new User is created within the UI. It will contain an email notification destination.
This User Profile will be assigned a unique NOTIFICATION_PROFILE_ID, and is uniquely associated with a single CopperEgg User.
...
Each User may edit their own Notifications Profile on the Personal Settings page: in the CopperEgg UI, click on the Settings tab; then click on Personal Settings in the Left Navigation panel; finally click on Notification Settings.
...
{% highlight sh %}
{
  "id":4028,                                 # unique NOTIFICATION_PROFILE_ID (generated by CopperEgg)
  "name":"Bobo",                             # name of this Notification Profile
  "user_id":9340,                            # CopperEgg-generated user_id, or null
  "destinations":[                           # array of notification destinations 
    {
      "id":7671,                             # NOTIFICATION_DESTINATION_ID (generated by CopperEgg)
    ...
    {
      "id":7672,                             # NOTIFICATION_DESTINATION_ID (generated by CopperEgg)
    ...
    {
      "id":7673,                             # NOTIFICATION_DESTINATION_ID (generated by CopperEgg)
      ...
      "options":{                            # options specific for this notification destination
        "apikey":"abcdef0123456789"          # in this case, CopperEgg User-specific ApiKey
      }
    }
  ]
}
...
Today there are 8 Notification Destination types defined:
* Email
* SMS
* Push
* HipChat
...
"destinations":[                          # array of all notification destination types
 ...
 {
   "id":7674,                             # NOTIFICATION_DESTINATION_ID (generated by CopperEgg)
 ...
 {
   "id":7675,                             # NOTIFICATION_DESTINATION_ID (generated by CopperEgg)
 ...
 {
   "id":7676,                             # NOTIFICATION_DESTINATION_ID (generated by CopperEgg)
 ...
 {
   "id":7677,                             # NOTIFICATION_DESTINATION_ID (generated by CopperEgg)
 ...
 {
   "id":7678,                             # NOTIFICATION_DESTINATION_ID (generated by CopperEgg)
...
***Note that the Create call will overwrite an existing profile
