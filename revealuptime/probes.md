...
'Probe' refers to a periodic test of an internet-connected service. Today the supported Probe types include TCP port connections, ICMP, HTTP GET/POST and HTTPS GET/POST. 
...
type
: A string that may be "GET", "POST", TCP or ICMP.  
