...
##Overview
--------
The API call for obtaining System Samples has a fair amount of detail, unlike many of the other CopperEgg API calls.  
...
#####Other System Sample Abbreviations
{% highlight sh %}
term               abbreviation
timestamp             '_ts'
...
###Example 1 Retrieving System Samples, using defaults.
----
...
[
 {
  ...
  "a":                                            # baked attributes
  {
   "p":1364954577                                 # most recent update time (timestamp) 
  },                           
  "hid":0,                                        # 'hidden; true == 1, false == 0
  "_ts":1364954290,                               # timestamp of offet 0
  ...
  "l_l":[0.98,1.36,1.4],                          # latest load 
  "m":                                            # last 5 min of memory metrics
  {
   "0":[1335.72,1786.73,1275.4,3784.5],
  ...
  {
   "0":[0.036,0.0,0.0193,0.0,0.0168,0.0,0.0,0.0,0.0],
